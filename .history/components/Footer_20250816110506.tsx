        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-3">
                ...
                <span className="font-semibold text-white text-lg">TCA IIT Ropar</span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li className="flex items-start text-gray-400">
                ...
                <a href="mailto:tcaiitropar@gmail.com" className="hover:text-amber-400">tcaiitrpr@gmail.com</a>
              </li>
              <li className="flex items-start text-gray-400">
           ...
           <div>
            <h3 className="text-lg font-semibold text-gray-200">Join the Community</h3>
            <p className="mt-4 text-sm text-gray-400">Are you a Telugu student at IIT Ropar? Click below to register and become a part of our family!</p>
             <a 
                href="https://tally.so/r/mZrlbz"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-block w-full text-center bg-amber-500 text-gray-900 font-bold py-3 px-4 rounded-md hover:bg-amber-400 transition-transform transform hover:scale-105"
             >
