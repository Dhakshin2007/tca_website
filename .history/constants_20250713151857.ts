...
export const TEAM_MEMBERS_2023: TeamMember[] = [
  { id: 5, name: 'Vijay Badugu', role: 'Secretary', department: 'Mechanical Department', year: 2022-26, imageUrl: 'https://picsum.photos/seed/nikhil/400/400', email: '2022meb1303@iitrpr.ac.in', linkedin: 'https://www.linkedin.com/in/badugu-vijay-a28366261/' },
  { id: 6, name: 'Pradeep', role: 'Treasurer', department: 'Electrical Department', year: 2022-26, imageUrl: 'https://picsum.photos/seed/anusha/400/400', email: 'a.kumari@iitrpr.ac.in', linkedin: 'https://www.linkedin.com/in/sai-pradeep-2050a728a/' },
  { id: 7, name: 'Deepak Teja Banoth', role: 'Sports Secretary', department: 'Metallurgy Department', year: 2022-26, imageUrl: 'https://picsum.photos/seed/anusha/400/400', email: '2022mmb1404@iitrpr.ac.in', linkedin: 'https://www.linkedin.com/in/banoth-deepak-teja/' },
  { id: 8, name: 'Kota Lohith', role: 'Cultural Secretary', department: 'Metallurgy Department', year: 2022-26, imageUrl: 'https://picsum.photos/seed/anusha/400/400', email: '2022mmb1384@iitrpr.ac.in', linkedin: 'https://www.linkedin.com/in/lohith-kota-4a5891272/' },
];


export const EVENTS: Event[] = [
  { id: 1, title: 'Bathukamma 2025', date: 'October 2, 2025', description: 'Experience the floral festival of Telangana. Join us for a vibrant celebration with traditional songs, dances, and beautifully arranged flower stacks.', imageUrl: 'https://picsum.photos/seed/bathukamma2025/800/600', type: 'upcoming' },
  { id: 2, title: 'Fresher Interaction 2025', date: 'TBD', description: 'A warm welcome to all the new Telugu students joining the IIT Ropar family.', imageUrl: 'https://picsum.photos/seed/freshers2025/800/600', type: 'upcoming' },
  { id: 5, title: 'SVSC Screening', date: 'March 7, 2024', description: "A fun night watching the classic Telugu movie 'Seethamma Vakitlo Sirimalle Chettu' with friends and popcorn.", imageUrl: 'https://picsum.photos/seed/svsc/800/600', type: 'past' },
  { id: 3, title: 'Bathukamma 2024', date: 'October 12, 2024', description: 'A colorful floral festival celebrating the vibrant culture of Telangana with traditional songs and dances.', imageUrl: 'https://picsum.photos/seed/bathukamma2024/800/600', type: 'past', youtubeLink: 'https://drive.google.com/drive/folders/1iI_6OEfZALUv6lszThgjm-05U8Reoq6F' },
];
...
export const DELEGATES: Delegate[] = [
  ...
  { name: 'Ganedi Durga Tejaswi', entryNumber: '2024MEB1327', position: 'SWE , CDPC' },
];
