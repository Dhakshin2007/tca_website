...
export const EVENTS: Event[] = [
  ...
  { id: 2, title: 'Fresher Interaction 2025', date: 'TBD', description: 'A warm welcome to all the new Telugu students joining the IIT Ropar family.', imageUrl: '/', type: 'upcoming' },
