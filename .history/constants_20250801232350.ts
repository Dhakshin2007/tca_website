...
export const EVENTS: Event[] = [
  ...
  { id: 4, title: 'Kingdom Screening', date: 'August , 2025', description: 'Experience the floral festival of Telangana and Andhra Pradesh. Join us for a vibrant celebration with traditional songs, dances, and beautifully arranged flower stacks.', imageUrl: '/Dush_25.jpg', type: 'upcoming' },
