...
export const EVENTS: Event[] = [
  ...
  { id: 4, title: 'Kingdom Screening', date: 'August 02, 2025', description: 'Kingdom is a Telugu Movie with Star Cast Vijay Devarkonda and Showing the essence of direction with Gowtham Sir', imageUrl: '/kind', type: 'upcoming' },
