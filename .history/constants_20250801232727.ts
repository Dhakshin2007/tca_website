...
export const EVENTS: Event[] = [
  ...
  { id: 4, title: 'Kingdom Screening', date: 'August 02, 2025', description: 'Kingdom is a Telugu Movie with Star Cast Vijay Devarkonda and Showing the essence of direction with Gowtham Sir', imageUrl: '/kind.avif', type: 'upcoming' },
...
export const STUDENTS: Student[] = [
    ...
    { id: 19, name: 'Chinthamalla Samhitha', entryNumber: '20241291', branch: 'Mathematics and computing', batch: 2024, email: '2024mcb1291@iitrpr.ac.in' },
