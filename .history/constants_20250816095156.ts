...
export const EVENTS: Event[] = [
  ...
  { id: 6, title: 'Coolie Screening', date: 'August 15, 2025', description: "A fun night watching the classic Telugu movie 'Seethamma Vakitlo Sirimalle Chettu' with friends and popcorn.", imageUrl: '/SVSC.jpg', type: 'past' },
];
