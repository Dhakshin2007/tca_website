...
export const EVENTS: Event[] = [
  ...
  { id: 6, title: 'Coolie Screening', date: 'August 15, 2025', description: "Starring Rajnikanth in Action with the Director Lokesh Kanagaraj has been ", imageUrl: '/SVSC.jpg', type: 'past' },
];
