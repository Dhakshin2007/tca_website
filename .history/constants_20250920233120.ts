...
export const TEAM_MEMBERS_2024: TeamMember[] = [
  { id: 1, name: 'Rajesh Naik', role: 'General Secretary', department: '-', year: '2023-27', imageUrl: 'https://picsum.photos/seed/sathvik/400/400', email: 's.reddy@iitrpr.ac.in', linkedin: '#' },
