...
export const TEAM_MEMBERS_2024: TeamMember[] = [
  ...
  { id: 2, name: 'Sai Mohith Reddy', role: 'Treasurer', department: '-', year: '2023-27', imageUrl: 'https://picsum.photos/seed/lakshmi/400/400', email: 'l.priya@iitrpr.ac.in', linkedin: '#' },
