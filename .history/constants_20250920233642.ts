...
export const TEAM_MEMBERS_2024: TeamMember[] = [
  { id: 1, name: 'Rajesh Naik', role: 'General Secretary', department: 'Mechanical', year: '2023-27', imageUrl: './rajesh.jpg', email: 'Rajesh Naik <2023meb1373@iitrpr.ac.in>', linkedin: 'https://www.linkedin.com/in/tejavath-rajesh-naik-39876a335/' },
  { id: 2, name: 'Sai Mohith Reddy', role: 'Treasurer', department: 'Mechanical', year: '2023-27', imageUrl: 'https://picsum.photos/seed/lakshmi/400/400', email: 'l.priya@iitrpr.ac.in', linkedin: '#' },
