...
export const TEAM_MEMBERS_2024: TeamMember[] = [
  ...
  { id: 3, name: 'Arun Rathod', role: 'Sports Secretary', department: '-', year: '2023-27', imageUrl: 'https://picsum.photos/seed/arjun/400/400', email: 'a.varma@iitrpr.ac.in', linkedin: '#' },
