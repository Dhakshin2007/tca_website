...
export const TEAM_MEMBERS_2024: TeamMember[] = [
  ...
  { id: 4, name: 'Akash', role: 'Cultural Secretary', department: 'Civil', year: '2023-27', imageUrl: 'https://picsum.photos/seed/keerthana/400/400', email: 'k.rao@iitrpr.ac.in', linkedin: '#' },
];
