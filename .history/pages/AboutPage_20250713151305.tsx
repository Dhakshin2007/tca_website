        ...
        <>
            ...
            <SectionWrapper idName="president-message">
                <div className="bg-gray-800 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 shadow-2xl shadow-amber-900/20">
                    <img src="https://picsum.photos/seed/president/200/200" alt="President" className="w-40 h-40 rounded-full object-cover border-4 border-amber-400" />
                    <div>
                        <h2 className="text-3xl font-bold text-amber-400">A Message from the President</h2>
