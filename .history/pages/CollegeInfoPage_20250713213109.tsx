  ...
  return (
    <div>
        <div className="bg-gray-800 py-16 text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-amber-400">About IIT Ropar</h1>
            <p className="mt-4 text-lg text-gray-300">Discover our campus, our culture, and what makes life here special.</p>
        </div>
        ...
        <SectionWrapper idName="college-info">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <InfoCard 
                    ...
                    imageUrl="https://picsum.photos/seed/facilities/600/400"
                ...
                <InfoCard 
                    ...
                    imageUrl="https://picsum.photos/seed/campuslife/600/400"
