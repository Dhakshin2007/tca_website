          ...
          <div className="space-y-8">
             <div className="bg-gray-800/50 p-8 rounded-lg shadow-xl">
                ...
                <ul className="space-y-4 text-gray-300">
                    <li className="flex items-center"><Icon name="mail" className="w-5 h-5 mr-3 text-amber-400" /> <a href="mailto:tcaiitroppr@gmail.com" className="hover:text-amber-300">tcaiitrpr@gmail.com</a></li>
